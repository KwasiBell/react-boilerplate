...
class Search extends Component {
  ...
  saveBook = bookId => {
    ...
    const selectedBook = this.state.books.find(each => each.id === bookId);
    console.log(selectedBook)
      // Need to have the above code go through this.state.books array and find the object inside that has an id that matches the bookId parameter passed into saveBook method.
